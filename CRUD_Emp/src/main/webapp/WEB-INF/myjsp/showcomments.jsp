  ...
  <style>
   ...
   .table-container {
    ...
    .table {
     ...
     body {
      background-image: url('https://martech.org/wp-content/uploads/2016/04/commenting_ss_1920.png'); 
...
<h1 style="color: white;" class="text-center page-title">Message Records!!</h1>
<div class="container justify-content-center">
  <div class="row">
    <c:forEach items="${listOfComments}" var="contactus" varStatus="loop">
      <div class="col-md-4 mb-3">
        <div class="card" style="max-width: 18rem;">
          <div class="card-header"> <b style="color:#243d9e">${contactus.contactName}</b></div>
          <div class="card-body">
            <h5 class="card-title"><b>Contact ID: ${contactus.contactId}</b></h5>
            <p class="card-text">
              <strong>Email:</strong> ${contactus.contactEmailId} <br>
              <strong>Message:</strong> <b style="color:red">${contactus.message} </b>
            </p>
          </div>
        </div>
      </div>
...
<div id="about" class="container-fluid bg-dark p-1" style="margin-top:260px">
