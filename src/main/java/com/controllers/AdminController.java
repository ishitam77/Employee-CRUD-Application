...
public class AdminController {
	...
	@PostMapping("/login")
	String authenticate(@RequestParam String email, @RequestParam String password, Model model,HttpSession session) {
	...
	String deleteAdmin(@RequestParam int adminId,Model model) {
		adminService.deleteAdmin(adminId); 
		  ...
		  return "redirect:/home"; //redirect to showAll mapping
		}
