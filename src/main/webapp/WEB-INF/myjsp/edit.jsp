...
<div class="container-form">
 <h2 style="color: green;" class="text-center page-title">Edit Employee Record!!</h2>
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="emailId" name="emailId" value="${employee.emailId}">
    </div>
    ...
    <button type="reset" class="btn btn-danger ml-2">Reverse <i class="fas fa-user-times ml-2"></i></button>
</div>
