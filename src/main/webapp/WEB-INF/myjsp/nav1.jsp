<nav class="navbar navbar-expand-sm navbar-dark bg-dark sticky-top">
  ...
  <ul class="navbar-nav">
    ...
    <li class="nav-item active">
      <a class="nav-link" href="contactus"><i class="fas fa-phone-square-alt"></i> ContactUs</a>
    </li>
  </ul>
<form class="form-inline my-2 my-lg-0 ml-auto"> 
    <a href="login" class="btn btn-warning text-white"><i class="fa-solid fa-right-to-bracket"></i> Login</a>
    <a href="adminreg" class="btn btn-danger ml-2"><i class="fa-solid fa-user"></i> SignUp</a>
</form>
</nav>